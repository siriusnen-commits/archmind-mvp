...
BRAIN_CASES = [
    {
        ...
        "expected_domains": ["notes"],
    },
    {
        "idea": "fullstack simple task tracker with fastapi backend and nextjs frontend",
        "expected_shape": "fullstack",
        "expected_template": "fullstack-ddd",
        "expected_domains": ["tasks"],
    },
    {
    ...
    {
        "idea": "realtime multiplayer web game",
        "expected_shape": "frontend",
        "expected_template": "nextjs",
        "expected_domains": [],
    },
    {
        "idea": "simple landing page for product showcase",
        "expected_shape": "frontend",
        "expected_template": "nextjs",
        "expected_domains": [],
    },
